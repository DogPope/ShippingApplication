...
namespace ShippingApplication {
    ...
    public partial class CustDataSet : global::System.Data.DataSet {
        ...
        public partial class CUSTOMERSDataTable : global::System.Data.TypedTableBase<CUSTOMERSRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public CUSTOMERSRow AddCUSTOMERSRow(int CUST_ID, string SURNAME, string FORENAME, string TOWN, string EIRCODE, string PASSWORD, string PHONE, string EMAIL, string CARDNUMBER, string COUNTY) {
...
namespace ShippingApplication.CustDataSetTableAdapters {
    ...
    public partial class CUSTOMERSTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO \"C##DANIEL\".\"CUSTOMERS\" (\"CUST_ID\", \"SURNAME\", \"FORENAME\", \"TOWN\", \"E" +
                "IRCODE\", \"PASSWORD\", \"PHONE\", \"EMAIL\", \"CARDNUMBER\", \"COUNTY\") VALUES (:CUST_ID," +
                " :SURNAME, :FORENAME, :TOWN, :EIRCODE, :PASSWORD, :PHONE, :EMAIL, :CARDNUMBER, :" +
                "COUNTY)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE ""C##DANIEL"".""CUSTOMERS"" SET ""CUST_ID"" = :CUST_ID, ""SURNAME"" = :SURNAME, ""FORENAME"" = :FORENAME, ""TOWN"" = :TOWN, ""EIRCODE"" = :EIRCODE, ""PASSWORD"" = :PASSWORD, ""PHONE"" = :PHONE, ""EMAIL"" = :EMAIL, ""CARDNUMBER"" = :CARDNUMBER, ""COUNTY"" = :COUNTY WHERE ((""CUST_ID"" = :Original_CUST_ID) AND (""SURNAME"" = :Original_SURNAME) AND (""FORENAME"" = :Original_FORENAME) AND (""TOWN"" = :Original_TOWN) AND (""EIRCODE"" = :Original_EIRCODE) AND (""PASSWORD"" = :Original_PASSWORD) AND (""PHONE"" = :Original_PHONE) AND (""EMAIL"" = :Original_EMAIL) AND (""CARDNUMBER"" = :Original_CARDNUMBER) AND ((:IsNull_COUNTY = 1 AND ""COUNTY"" IS NULL) OR (""COUNTY"" = :Original_COUNTY)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT CUST_ID, SURNAME, FORENAME, TOWN, EIRCODE, PASSWORD, PHONE, EMAIL, CARDNUM" +
                "BER, COUNTY FROM \"C##DANIEL\".CUSTOMERS";
        ...
        public virtual int Delete(int Original_CUST_ID, string Original_SURNAME, string Original_FORENAME, string Original_TOWN, string Original_EIRCODE, string Original_PASSWORD, string Original_PHONE, string Original_EMAIL, string Original_CARDNUMBER, string Original_COUNTY) {
        ...
        public virtual int Insert(int CUST_ID, string SURNAME, string FORENAME, string TOWN, string EIRCODE, string PASSWORD, string PHONE, string EMAIL, string CARDNUMBER, string COUNTY) {
        ...
        public virtual int Update(
            ...
            if ((Original_EIRCODE == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[14].Value = ((string)(Original_EIRCODE));
            }
            if ((Original_PASSWORD == null)) {
                throw new global::System.ArgumentNullException("Original_PASSWORD");
            }
            ...
            if ((Original_CARDNUMBER == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[18].Value = ((string)(Original_CARDNUMBER));
            }
            if ((Original_COUNTY == null)) {
        ...
        public virtual int Update(
                    ...
                    string Original_CARDNUMBER, 
                    string Original_COUNTY) {
            return this.Update(Original_CUST_ID, SURNAME, FORENAME, TOWN, EIRCODE, PASSWORD, PHONE, EMAIL, CARDNUMBER, COUNTY, Original_CUST_ID, Original_SURNAME, Original_FORENAME, Original_TOWN, Original_EIRCODE, Original_PASSWORD, Original_PHONE, Original_EMAIL, Original_CARDNUMBER, Original_COUNTY);
        }
    }
